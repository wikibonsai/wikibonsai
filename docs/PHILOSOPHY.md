...
Every action we take follows a (sub)consciously plotted a course and moves in some direction. Here lies a constellation of philosophical "(north) stars" that guide the direction of the WikiBonsai project.
...
This project keeps in mind a few of those possible preconditions with a particular focus on preserving integrity of the individual, the environment, and the individual's relationship with said environment.
